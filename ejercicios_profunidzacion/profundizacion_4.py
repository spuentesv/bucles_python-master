...
while (posicion < temperatura_len):
    temperatura = temp_dataloger[posicion]
    print('Temperatura en', temperatura, ' es ', posicion)   
    posicion += 1 
...
temperatura_sumatoria = sum(temp_dataloger[: -1])
...
print('Temperatura Maxima:', temperatura_max, ' Temperatura Minima:',  temperatura_min, ' Temperatura Promedio:', round(temperatura_promedio,2)) 
